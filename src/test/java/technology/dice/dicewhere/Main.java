    ...
    IPResolver.Builder resolverBuilder =
        new IPResolver.Builder()
            .withProvider(
                new MaxmindDbReader(
                    Paths.get(
                        "/Users/gluiz/Downloads/GeoIP2-City-CSV_20180703/GeoIP2-City-Locations-en.csv.zip"),
                    Paths.get(
                        "/Users/gluiz/Downloads/GeoIP2-City-CSV_20180703/GeoIP2-City-Blocks-IPv4.csv.zip"),
                    Paths.get(
